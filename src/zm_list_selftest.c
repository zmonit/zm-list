/*  =========================================================================
    zm_list_selftest.c - run selftests
...
// Tests for draft public classes:
    { "zm_list", zm_list_test },
#endif // ZM_LIST_BUILD_DRAFT_API
#ifdef ZM_LIST_BUILD_DRAFT_API
    { "private_classes", zm_list_private_selftest },
#endif // ZM_LIST_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running zm-list selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("zm_list_selftest.c [options] ...");
